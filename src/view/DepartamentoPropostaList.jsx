...
export default function PropostasPageDepartamento() {
    ...
    <div>
        ...
        <div className="offcanvas-body">
          <ul className="navbar-nav justify-content-end flex-grow-1 pe-3">
            <li className="nav-item">
              <Link className="nav-link" to="/RemoverContas">
      ...
      <div className="container pt-5">
        <button
          ...
          onClick={() => navigate("/departamento/add")}
        ...
        <div className="row pb-5">
          ...
          >
            {propostasFiltradas.map((p) => (
              <div
                key={p.id_propostas}
                className={`p-3 mb-2 rounded ${propostaAtiva?.id_propostas === p.id_propostas
              ...
              >
                ...
                <div className="cut-overflow">{p.descricao?.substring(0, 50)}...</div>
                    ...
                    {propostaAtiva.estado === "activa" && (
                      <>
                        <button
                          ...
                          onClick={() =>
                            navigate(
                              `/departamento/edit/${propostaAtiva.id_propostas}`
                            )
                          }
                        >
                          Editar
