...
export default function RemoverContas() {
  const utilizadores = [
    { numero: "2021001", nome: "George R.R Martin", curso: "Ambiente" },
    { numero: "2021002", nome: "Markus Suzak", curso: "Engenharia Civil" },
    { numero: "2021003", nome: "George R.R Martin", curso: "Engenharia Electrotécnica" },
    { numero: "2021004", nome: "George R.R Martin", curso: "Engenharia de Madeiras" },
    { numero: "2021005", nome: "Markus Suzak", curso: "Engenharia Mecânica e Gestão Industrial" },
  ...
  return (
    <>
      ...
      <nav className="navbar bg-body-tertiary fixed-top">
        <BotaoVoltar backUrl="/departamento/list" />
      ...
      >
        <div className="offcanvas-header">
          ...
          <h5 className="offcanvas-title ms-2" id="offcanvasNavbarLabel">Departamentos</h5>
          <button
            type="button"
            className="btn-close"
            data-bs-dismiss="offcanvas"
        ...
        <div className="offcanvas-body">
          ...
          <Link className="nav-link text-danger" to="/">Terminar sessão</Link>
        </div>
      </div>
